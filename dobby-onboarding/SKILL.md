---
name: dobby-onboarding
description: 教你如何让新多比快速上手。当你换了一个新多比、项目新增了多比、或多比对当前项目完全不了解时，使用此 Skill。适用场景包括：新多比第一天、多比从别的项目调过来、旧多比被换掉需要新多比接手。只要多比看起来一脸茫然，就该用这个 Skill。
---
