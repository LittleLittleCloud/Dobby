---
name: dobby-communication
description: 教你如何和多比沟通。当你需要给多比下指令、催进度、拒绝多比的请求、或者多比听不懂你在说什么时，使用此 Skill。适用场景包括：多比理解错了任务、多比话太多、多比不回复、多比情绪化。只要和多比的沟通出了问题，就该用这个 Skill。
---
